...
print((list(filter(lambda masina: True if masina.marca == "BMW" else False, masini))))
...
marca_masinii = input("Marca masinii: ")

print(f"{len(list(filter(lambda masina: True if masina.marca == marca_masinii else False, masini)))} "
      f"masini {marca_masinii}")
